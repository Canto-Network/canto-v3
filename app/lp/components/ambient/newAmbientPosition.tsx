...
type positionType = "knockout" | "concentrated" | "none";
...
export const NewAmbientBasePositionModal = ({
  pool,
  sendTxFlow,
  verifyParams,
}: NewPositionModalProps) => {
  const [ambientPositionType, setAmbientPositionType] =
    useState<positionType>("none");
  return (
    <Container>
      {ambientPositionType === "none" && (
        <Container direction="column" gap={20} style={{ alignItems: "center" }}>
          <Button onClick={() => setAmbientPositionType("concentrated")}>
            Add Concentrated Liquidity
          </Button>
          <Button onClick={() => setAmbientPositionType("knockout")}>
            Create Limit Order
          </Button>
        </Container>
      )}
      {ambientPositionType === "concentrated" && (
      ...
      {ambientPositionType === "knockout" && (
        <NewKnockoutPositionModal
          pool={pool}
          sendTxFlow={sendTxFlow}
          verifyParams={verifyParams}
        />
...
export const NewKnockoutPositionModal = ({
  pool,
  sendTxFlow,
  verifyParams,
}: NewPositionModalProps) => {
